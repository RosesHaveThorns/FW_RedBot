...
*$honupdate <username> <requirement, **no spaces**>*
    ...
    - Note **this command is only available in #honorary-red-logging**
...
*$dice <sides>*
    - Generates a random number between 1 and <sides>, inclusively 
    - There is no maximum amount for sides as far as I know
